...
[TOC]  
<!-- TOC start -->  
- [📘 Cheat Sheet: Đồng bộ Git từ GitHub (bỏ thay đổi local)](#-cheat-sheet-đồng-bộ-git-từ-github-bỏ-thay-đổi-local)
  - [🎯 Mục tiêu:](#-mục-tiêu)
  - [🛠️ Thao tác đầy đủ:](#️-thao-tác-đầy-đủ)
- [Bước 1: Lấy thông tin mới nhất từ GitHub](#bước-1-lấy-thông-tin-mới-nhất-từ-github)
- [Bước 2: Ghi đè toàn bộ mã nguồn local bằng bản trên GitHub](#bước-2-ghi-đè-toàn-bộ-mã-nguồn-local-bằng-bản-trên-github)
- [Bước 3: Xoá sạch các file/thư mục không được Git quản lý (nếu có)](#bước-3-xoá-sạch-các-filethư-mục-không-được-git-quản-lý-nếu-có)
- [Bước 4: Kéo lại lần nữa (nếu cần)](#bước-4-kéo-lại-lần-nữa-nếu-cần)
- [🧠 Git Cheat Sheet – Cơ bản \& Thực tế (phiên sử dụng)](#-git-cheat-sheet--cơ-bản--thực-tế-phiên-sử-dụng)
  - [📝 1. Kiểm tra trạng thái repository](#-1-kiểm-tra-trạng-thái-repository)
  - [🔄 2. Lấy thông tin mới từ GitHub (fetch)](#-2-lấy-thông-tin-mới-từ-github-fetch)
  - [📣 3. Kiểm tra lại sau khi fetch](#-3-kiểm-tra-lại-sau-khi-fetch)
  - [⬇️ 4. Kéo thay đổi từ GitHub (pull)](#️-4-kéo-thay-đổi-từ-github-pull)
  - [🔍 5. Xem danh sách commit tóm tắt](#-5-xem-danh-sách-commit-tóm-tắt)
  - [🔎 6. Xem chi tiết nội dung commit](#-6-xem-chi-tiết-nội-dung-commit)
  - [🌿 7. Tạo nhánh mới để làm việc](#-7-tạo-nhánh-mới-để-làm-việc)
  - [💾 8. Thêm thay đổi vào staging](#-8-thêm-thay-đổi-vào-staging)
  - [📦 9. Commit thay đổi](#-9-commit-thay-đổi)
  - [🚀 10. Đẩy commit lên GitHub](#-10-đẩy-commit-lên-github)
  - [🧹 Phụ – Khôi phục file chưa commit](#-phụ--khôi-phục-file-chưa-commit)
- [summary github pracctice 170525](#summary-github-pracctice-170525)
- [Ghi chú ssript quan trọng](#ghi-chú-ssript-quan-trọng)
- [Learning github](#learning-github)
- [Học github:](#học-github)
- [Hebrew songs](#hebrew-songs)
  - [Meditative songs](#meditative-songs)
    ...
    - [Elohai N’shamah](#elohai-nshamah)
- [Chinese language](#chinese-language)
  ...
  - [Chinese poems.](#chinese-poems)
    ...
    - [賊退示官吏](#賊退示官吏-1)
      - [Yue yu](#yue-yu-2)
      - [Yue yu yi](#yue-yu-yi-1)
  - [Tiếng Việt](#tiếng-việt)
    - [Chú đại bi](#chú-đại-bi)
- [English songs](#english-songs)
- [Heaven](#heaven)
- [Hoang di nei jing](#hoang-di-nei-jing)
- [Nội kinh chương bản thần trang 347 quyển 6](#nội-kinh-chương-bản-thần-trang-347-quyển-6)
  - [Hoa văn](#hoa-văn)
  - [Tiếng Việt](#tiếng-việt-1)
    - [Thần là gốc của con người](#thần-là-gốc-của-con-người)
<!-- TOC end -->  
...
# 📘 Cheat Sheet: Đồng bộ Git từ GitHub (bỏ thay đổi local)

## 🎯 Mục tiêu:
Khi bạn muốn cập nhật mã nguồn từ GitHub **và bỏ mọi thay đổi cục bộ** (⚠️ mất thay đổi chưa commit).    

---    

## 🛠️ Thao tác đầy đủ:
```bash    
# Bước 1: Lấy thông tin mới nhất từ GitHub
git fetch origin    

# Bước 2: Ghi đè toàn bộ mã nguồn local bằng bản trên GitHub
git reset --hard origin/main    

# Bước 3: Xoá sạch các file/thư mục không được Git quản lý (nếu có)
git clean -fd    

# Bước 4: Kéo lại lần nữa (nếu cần)
...
✅ Thêm file vào Git staging: git add test.txt      
...
# Học github:
- chuyển tới thư mục: cd ~/Documents/dtcs25_sstt        
- cd dtcs25_sstt        
- git status        
- git log --oneline        
...
### Ana kiboach              
  ...
  גְדֻּלַּת יְמִינְךָ                                                                    
  g’dulat yemincha,                                                                    
  And the greatness of thy right arm                                                                    
  תַּתִּיר צְרוּרָה                                                                    
  tatir tz’rura                                                                    
  ...
  דוֹרְשֵׁי יִחוּדְךָ                                                                    
  dorshei yichudcha                                                                    
  They who pursue your uniqueness-                                                                    
  כְּבָבַת שָׁמְרֵם                                                                    
  k’vavat shamrem                                                                    
  ...
  רַחֲמֵי צִדְקָתְךָ                                                                    
  rachamei tzidkatcha                                                                    
  Pity them; may your righteousness                                                                    
  תָּמִיד גָמְלֵם                                                                    
  Tamid gamlem                                                                    
  Always reward them                                                                    
  חֲסִין קָדוֹשׁ                                                                    
  ...
  To those who remember your holiness                                                                    
  שַׁוְעָתֵנוּ קַבֵּל                                                                    
  Shavateinu kabel                                                                    
  Accept our cries                                                                    
...
וְאַתָּה עָתִיד לִטְלָהּ מִמֶּנִּי            
V’atah atid lit’lah mimeni            
And You are destined to take it from me            

וּלְהַחֲזִירָהּ בִּי לֶעָתִיד לָבוֹא.            
Ul’hachazirah bi l’atid lavo.            
And to restore it to me in the time to come.            
...
רִבּוֹן כָּל הַמַּעֲשִׂים, מוֹשֵׁל בְּכָל הַבְּרוּאִים,            
Ribon kol ha-ma’asim, moshel b’chol ha-b’ru’im,            
Master of all deeds, ruler of all created beings,            

אֲדוֹן כָּל הַנְּשָׁמוֹת.            
Adon kol ha-n’shamot.            
...
Ha-machazir n’shamot lif’garim meitim.            
...
### 大悲咒- 全文              
  ...
  ####  Pin yin              
   ...
   Xī suì féng tàipíng,                                                                    
   shānlín èrshí nián.                                                                    
   Quányuán zài tíng hù,                                                                    
   dòng hè dāng ménqián.                                                                    
   ...
   rén pín shāng kělián.                                                                    
   Shì yǐ xiàn lín jìng,                                                                    
   cǐ zhōu dú jiàn quán.                                                                    
   Shǐ chén jiāng wángmìng,                                                                    
   qǐ bùrú zéi yān?                                                                    
   Lìng bǐ zhēng liǎn zhě,                                                                    
   pò zhī rú huǒ jiān.                                                                    
   Shuí néng jué rénmìng?                                                                    
   Yǐ zuò shí shì xián.                                                                    
   Sī yù wěi fújié,                                                                    
   yǐn gān zì cì chuán,                                                                    
...
####  Hanyu              
  ...
  Gāo wò nán zhāi shí,                                                                    
   kāi wéi yuèchū tǔ.                                                                    
   Qīnghuī dànshuǐ mù,                                                                    
   yǎn yàng zài chuānghù.                                                                    
   Rǎn rǎn jǐ yíng xū,                                                                    
   chéng chéng biàn jīn gǔ.                                                                    
   Měirén qīng jiāng pàn,                                                                    
   shì yè yuè yín kǔ.                                                                    
   Qiānlǐ qí rúhé,                                                                    
   wéi fēngchuī lán dù.                                                                    
...
# Heaven              
