...
<!-- TOC start -->  
  - [TopPage](#toppage)  
- [📘 Cheat Sheet: Đồng bộ Git từ GitHub (bỏ thay đổi local)](#-cheat-sheet-dong-bo-git-tu-github-bo-thay-doi-local)  
  - [🎯 Mục tiêu:](#-muc-tieu)  
  - [🛠️ Thao tác đầy đủ:](#-thao-tac-day-du)  
- [Bước 1: Lấy thông tin mới nhất từ GitHub](#buoc-1-lay-thong-tin-moi-nhat-tu-github)  
- [Bước 2: Ghi đè toàn bộ mã nguồn local bằng bản trên GitHub](#buoc-2-ghi-de-toan-bo-ma-nguon-local-bang-ban-tren-github)  
- [Bước 3: Xoá sạch các file/thư mục không được Git quản lý (nếu có)](#buoc-3-xoa-sach-cac-filethu-muc-khong-duoc-git-quan-ly-neu-co)  
- [Bước 4: Kéo lại lần nữa (nếu cần)](#buoc-4-keo-lai-lan-nua-neu-can)  
- [🧠 Git Cheat Sheet – Cơ bản & Thực tế (phiên sử dụng)](#-git-cheat-sheet---co-ban-thuc-te-phien-su-dung)  
  - [📝 1. Kiểm tra trạng thái repository](#-1-kiem-tra-trang-thai-repository)  
  - [🔄 2. Lấy thông tin mới từ GitHub (fetch)](#-2-lay-thong-tin-moi-tu-github-fetch)  
  - [📣 3. Kiểm tra lại sau khi fetch](#-3-kiem-tra-lai-sau-khi-fetch)  
  - [⬇️ 4. Kéo thay đổi từ GitHub (pull)](#-4-keo-thay-doi-tu-github-pull)  
  - [🔍 5. Xem danh sách commit tóm tắt](#-5-xem-danh-sach-commit-tom-tat)  
  - [🔎 6. Xem chi tiết nội dung commit](#-6-xem-chi-tiet-noi-dung-commit)  
  - [🌿 7. Tạo nhánh mới để làm việc](#-7-tao-nhanh-moi-de-lam-viec)  
  - [💾 8. Thêm thay đổi vào staging](#-8-them-thay-doi-vao-staging)  
  - [📦 9. Commit thay đổi](#-9-commit-thay-doi)  
  - [🚀 10. Đẩy commit lên GitHub](#-10-day-commit-len-github)  
  - [🧹 Phụ – Khôi phục file chưa commit](#-phu---khoi-phuc-file-chua-commit)  
- [summary github pracctice 170525](#summary-github-pracctice-170525)  
- [Ghi chú ssript quan trọng](#ghi-chu-ssript-quan-trong)  
- [Learning github](#learning-github)  
- [Học github:](#hoc-github)  
...
- [Nội kinh chương bản thần trang 347 quyển 6](#noi-kinh-chuong-ban-than-trang-347-quyen-6)  
  - [Hoa văn](#hoa-van)  
  - [Tiếng Việt](#tieng-viet)  
    - [Thần là gốc của con người](#than-la-goc-cua-con-nguoi)  
<!-- TOC end -->  
